...
declare const SUPERCODE_LIBC: string | undefined
...
export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.SUPERCODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.SUPERCODE_EXPERIMENTAL_FILEWATCHER) {
